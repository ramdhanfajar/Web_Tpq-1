...
// --- 2. FITUR PENCARIAN SANTRI ---
$search = isset($_GET['search']) ? trim($_GET['search']) : "";

// Jika ada kata pencarian, tambahkan WHERE
...
if ($keyword != '') {
    $sql = "SELECT s.id, s.nis, s.nama_lengkap, s.nama_wali, s.no_telepon_wali, k.nama_kelas
            ...
            WHERE s.nis LIKE '%$keyword%' 
               OR s.nama_lengkap LIKE '%$keyword%' 
               OR s.nama_wali LIKE '%$keyword%'
                ...
                <div class="card-header">
                    ...
                    <div class="search-bar">
                        <form method="GET" action="data_santri.php">
                            ...
                            <input type="text" name="search" placeholder="Cari santri..." 
